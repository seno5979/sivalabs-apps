...
public class SpringEmailService
{
	...
	public SpringEmailService(EmailConfiguration configuration)
	{
	...
	{
		String emailId = configuration
				.getProperty(EmailConfiguration.SMTP_AUTH_USER);
		String password = configuration
				.getProperty(EmailConfiguration.SMTP_AUTH_PWD);
	...
	public void sendEmail(Email email)
	{
		Session session = Session.getDefaultInstance(
				this.configuration.getProperties(), auth);
		boolean debug = Boolean.valueOf(this.configuration
				.getProperty(EmailConfiguration.DEBUG));
	...
	private Message buildEmailMessage(Session session, Email email)
	...
	private void addRecievers(Message msg, Email email)
			throws MessagingException
	{
	...
	private void addMessageBodyPart(Multipart multipart, Email email)
			throws MessagingException
	{
	...
	private void addAttachments(Multipart multipart, Email email)
			throws MessagingException
	{
